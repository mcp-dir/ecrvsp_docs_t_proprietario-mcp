...
ECRVSP Documentos: Transferência de Proprietário segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [ecrvsp_docs_t_proprietario@mcp.ai](mailto:ecrvsp_docs_t_proprietario@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
